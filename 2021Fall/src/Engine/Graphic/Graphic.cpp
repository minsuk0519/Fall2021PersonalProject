...
void Graphic::init()
{
    ...
    //create texture image
    {
        ...
        vulkanTextureImageView = createImageView(vulkanTextureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
    }
...
void Graphic::SetupSwapChain()
{
    ...
    //image views
    {
        ...
        for (size_t i = 0; i < vulkanSwapChainImages.size(); i++)
        {
            vulkanSwapChainImageViews[i] = createImageView(vulkanSwapChainImages[i], vulkanSwapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT);
        }
    }
    ...
    VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT
        ...
        createImage(Settings::windowWidth, Settings::windowHeight, vulkanDepthFormat, VK_IMAGE_TILING_OPTIMAL,
            VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, vulkanDepthImage, vulkanDepthImageMemory);

        vulkanDepthImageView = createImageView(vulkanDepthImage, vulkanDepthFormat, VK_IMAGE_ASPECT_DEPTH_BIT);
...
VkImageView Graphic::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
