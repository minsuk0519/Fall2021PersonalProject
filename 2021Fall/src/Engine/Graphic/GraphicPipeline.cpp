...
void GraphicPipeline::init2(VkRenderPass renderpass, VkDescriptorSetLayout descriptorSetLayout, VkSampleCountFlagBits msaaSamples)
{
	VkShaderModule vertShaderModule = CreatevulkanShaderModule(Helper::readFile("data/shaders/deferredvert.spv"));
	VkShaderModule fragShaderModule = CreatevulkanShaderModule(Helper::readFile("data/shaders/deferredfrag.spv"));
